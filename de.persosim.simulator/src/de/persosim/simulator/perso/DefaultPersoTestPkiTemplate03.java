...
public class DefaultPersoTestPkiTemplate03 extends DefaultPersoTestPki {
	...
	protected void addEidDg9(DedicatedFile eIdAppl) {
		CardFile eidDg9 = new ElementaryFile(
				...
				HexString
						.toByteArray("690CA10A0C084DC39C4E4348454E"),
	...
	protected void addEidDg17(DedicatedFile eIdAppl) {
		CardFile eidDg17 = new ElementaryFile(
				...
				HexString
						.toByteArray("712E302CAA120C10424F554348C3895354522E2036382041AB080C064245524C494EAD03130144AE0713053132303539"),
	...
	protected void addAuthObjects() throws NoSuchAlgorithmException,
		...
		MrzAuthObject mrz = new MrzAuthObject(
				...
				"IDD<<0123456784<<<<<<<<<<<<<<<2804213F2010315D<<<<<<<<<<<<<0MUSTERMANN<<JOHANNA<EDELTRAUT<");
		mf.addChild(mrz);
	...
	protected void addEpassDatagroup1(DedicatedFile ePassAppl) {
		...
		CardFile epassDg1 = new ElementaryFile(
				...
				HexString.toByteArray("615D5F1F5A4944443C3C303132333435363738343C3C3C3C3C3C3C3C3C3C3C3C3C3C3C323830343231334632303130333135443C3C3C3C3C3C3C3C3C3C3C3C3C304D55535445524D414E4E3C3C4A4F48414E4E41204544454C54524155543C"),
