...
public class DefaultPersoTestPkiTemplate06 extends DefaultPersoTestPki {
	...
	protected void addAuthObjects() throws NoSuchAlgorithmException,
		...
		MrzAuthObject mrz = new MrzAuthObject(
				...
				"IDD<<0123456784<<<<<<<<<<<<<<<4601254M2010315D<<<<<<<<<<<<<6VONDREBENBUSCHDALGOSSEN<<HANS<");
		mf.addChild(mrz);
	...
	protected void addEpassDatagroup1(DedicatedFile ePassAppl) {
		...
		CardFile epassDg1 = new ElementaryFile(
				...
				HexString.toByteArray("615D5F1F5A4944443C3C303132333435363738343C3C3C3C3C3C3C3C3C3C3C3C3C3C3C343630313235344D32303130333135443C3C3C3C3C3C3C3C3C3C3C3C3C36564F4E44524542454E425553434844414C474F5353454E3C3C48414E533C"),
