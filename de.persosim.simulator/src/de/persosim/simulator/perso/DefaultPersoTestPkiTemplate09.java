...
public class DefaultPersoTestPkiTemplate09 extends DefaultPersoTestPkiTemplate {
	...
	protected void addEidDg9(DedicatedFile eIdAppl) {
		CardFile eidDg9 = new ElementaryFile(
				...
				HexString
						.toByteArray("691AA1180C164DC39C484C48415553454E2F5448C39C52494E47454E"),
	...
	protected void addAuthObjects() throws NoSuchAlgorithmException,
		...
		MrzAuthObject mrz = new MrzAuthObject(
				...
				"IDD<<0123456784<<<<<<<<<<<<<<<0203306F1610316D<<<<<<<<<<<<<0SCHUSTER<<LILLY<<<<<<<<<<<<<<<");
		mf.addChild(mrz);
	...
	protected void addEpassDatagroup1(DedicatedFile ePassAppl) {
		...
		CardFile epassDg1 = new ElementaryFile(
				...
				HexString.toByteArray("615D5F1F5A4944443C3C303132333435363738343C3C3C3C3C3C3C3C3C3C3C3C3C3C3C303230333330364631363130333136443C3C3C3C3C3C3C3C3C3C3C3C3C3053434855535445523C3C4C494C4C593C3C3C3C3C3C3C3C3C3C3C3C3C3C3C"),
