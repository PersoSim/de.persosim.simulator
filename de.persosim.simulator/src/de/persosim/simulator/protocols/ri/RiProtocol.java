...
public class RiProtocol implements Protocol, Iso7816, ApduSpecificationConstants,
	...
	private HashSet<ApduSpecification> createApduSpecifications() {
		...
		ConstructedTlvSpecification tagSpecification = new ConstructedTlvSpecification(TAG_80);
		apduSpecification.addTag(tagSpecification);
		tagSpecification = new ConstructedTlvSpecification(TAG_84);
		...
		tagSpecification = new ConstructedTlvSpecification(TAG_7C);
		apduSpecification.addTag(tagSpecification);
		apdus.add(apduSpecification);
		return apdus;
	}
