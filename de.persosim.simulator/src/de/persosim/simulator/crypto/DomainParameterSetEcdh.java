...
//	@XmlElement
	...
	public ConstructedTlvDataObject getAlgorithmIdentifier() {
		...
		ConstructedTlvDataObject seq1 = new ConstructedTlvDataObject(TlvConstants.TAG_SEQUENCE);
		seq1.addTlvDataObject(new PrimitiveTlvDataObject(TlvConstants.TAG_OID, HexString.toByteArray("2A8648CE3D0101")));
		seq1.addTlvDataObject(new PrimitiveTlvDataObject(TlvConstants.TAG_INTEGER, HexString.toByteArray("00A9FB57DBA1EEA9BC3E660A909D838D726E3BF623D52620282013481D1F6E5377")));

		ConstructedTlvDataObject seq2 = new ConstructedTlvDataObject(TlvConstants.TAG_SEQUENCE);
		seq2.addTlvDataObject(new PrimitiveTlvDataObject(TlvConstants.TAG_OCTET_STRING, HexString.toByteArray("7D5A0975FC2C3057EEF67530417AFFE7FB8055C126DC5C6CE94A4B44F330B5D9")));
		seq2.addTlvDataObject(new PrimitiveTlvDataObject(TlvConstants.TAG_OCTET_STRING, HexString.toByteArray("26DC5C6CE94A4B44F330B5D9BBD77CBF958416295CF7E1CE6BCCDC18FF8C07B6")));
		
		PrimitiveTlvDataObject os1 = new PrimitiveTlvDataObject(TlvConstants.TAG_OCTET_STRING, HexString.toByteArray("048BD2AEB9CB7E57CB2C4B482FFC81B7AFB9DE27E1E3BD23C23A4453BD9ACE3262547EF835C3DAC4FD97F8461A14611DC9C27745132DED8E545C1D54C72F046997"));
		PrimitiveTlvDataObject int2 = new PrimitiveTlvDataObject(TlvConstants.TAG_INTEGER, HexString.toByteArray("00A9FB57DBA1EEA9BC3E660A909D838D718C397AA3B561A6F7901E0E82974856A7"));
	   
		ConstructedTlvDataObject params = new ConstructedTlvDataObject(TlvConstants.TAG_SEQUENCE);
		params.addTlvDataObject(new PrimitiveTlvDataObject(TlvConstants.TAG_INTEGER, new byte[] {0x01}));
		params.addTlvDataObject(seq1);
    	params.addTlvDataObject(seq2);
    	params.addTlvDataObject(os1);
    	params.addTlvDataObject(int2);
    	params.addTlvDataObject(new PrimitiveTlvDataObject(TlvConstants.TAG_INTEGER, new byte[] {0x01}));
