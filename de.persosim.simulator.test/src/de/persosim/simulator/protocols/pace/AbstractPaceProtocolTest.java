...
public class AbstractPaceProtocolTest extends PersoSimTestCase {
	...
	public void setUp() throws ReflectiveOperationException {
		...
		cvcaIsTlv = (ConstructedTlvDataObject) ((ConstructedTlvDataObject)new TlvDataObjectContainer(cvcaIsData).getTagField(TR03110Utils.TAG_7F21)).getTagField(TR03110Utils.TAG_7F4E);
		cvcaIsCarTlv = ((ConstructedTlvDataObject)((ConstructedTlvDataObject)new TlvDataObjectContainer(cvcaIsData).getTagField(TR03110Utils.TAG_7F21)).getTagField(TR03110Utils.TAG_7F4E)).getTagField(TR03110Utils.TAG_42);
