...
public class Tr03111UtilsTest extends PersoSimTestCase {	
	...
	public void testI2os_NegativeBigInt() {
	 ...
	 */
	@Test(expected = IllegalArgumentException.class)
	public void testI2os_lengthSmallerThanOctetString() {
		BigInteger bigInt = new BigInteger("42");
	 ...
	 */
	@Test
	public void testI2os_lengthMatchingOctetString() {
		BigInteger bigInt = new BigInteger("42");
	 ...
	 */
	@Test
	public void testI2os_lengthLongerThanOctetString() {
		BigInteger bigInt = new BigInteger("42");
