 ...
 *
 */
public class DefaultPersoTestPkiTemplate05 extends DefaultPersoTestPki {
	
	@Override
	protected void addAuxData() {
		// Aux data
		byte[] communityId = HexString.toByteArray("02761406120000"); // updated
		
		Calendar calendar = Calendar.getInstance();
		
		calendar.set(1989, Calendar.DECEMBER, 31, 0, 0, 0); // updated
	...
	protected void addEidDg4(DedicatedFile eIdAppl) {
		CardFile eidDg4 = new ElementaryFile(new FileIdentifier(0x0104),
				...
				HexString.toByteArray("6408120641C49EC38741"),
	...
	protected void addEidDg5(DedicatedFile eIdAppl) {
		CardFile eidDg5 = new ElementaryFile(
				...
				HexString
						.toByteArray("650A0C08C3965A4DCC82454E"),
	...
	protected void addEidDg18(DedicatedFile eIdAppl) {
		CardFile eidDg18 = new ElementaryFile(new FileIdentifier(0x0112),
				...
				HexString.toByteArray("7209040702761406120000"),
	...
	protected void addAuthObjects() throws NoSuchAlgorithmException,
		...
		MrzAuthObject mrz = new MrzAuthObject(
				...
				"IDD<<0123456784<<<<<<<<<<<<<<<89<<<<3F1610316D<<<<<<<<<<<<<0OEZMEN<<AGCA<<<<<<<<<<<<<<<<<<");
		mf.addChild(mrz);
	...
	protected void addEpassDatagroup1(DedicatedFile ePassAppl) {
		...
		CardFile epassDg1 = new ElementaryFile(
				...
				HexString.toByteArray("615D5F1F5A4944443C3C303132333435363738343C3C3C3C3C3C3C3C3C3C3C3C3C3C3C38393C3C3C3C334631363130333136443C3C3C3C3C3C3C3C3C3C3C3C3C304F455A4D454E3C3C414743413C3C3C3C3C3C3C3C3C3C3C3C3C3C3C3C3C3C"),
