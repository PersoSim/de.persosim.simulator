...
public class DefaultPersonalization extends XmlPersonalisation {
	...
	public void buildObjectTree() {
		try {
			...
			SecCondition paceWithPin = new PaceWithPasswordSecurityCondition((PasswordAuthObject) mf.findChildren(new AuthObjectIdentifier(3)).iterator().next());
			...
			addEpassDatagroups(paceSet, taWithIsDg3Set, taWithIsDg4Set, ePassAppl);
	...
	protected void addEfChipSecurity(HashSet<SecCondition> taForChipSecuritySet) {
		...
		ElementaryFile efChipSecurity = new ElementaryFile(
				...
				.toByteArray(), taForChipSecuritySet, Collections.<SecCondition> emptySet(), Collections.<SecCondition> emptySet());
	...
	protected void addEfCardSecurity(HashSet<SecCondition> taSet) {
		...
		ElementaryFile efCardSecurity = new ElementaryFile(
				...
				.toByteArray(), taSet, Collections.<SecCondition> emptySet(), Collections.<SecCondition> emptySet());
	...
	protected void addEfCardAccess(HashSet<SecCondition> unprotectedSet) {
		...
		ElementaryFile efCardAccess = new ElementaryFile (
				...
				.toByteArray(), unprotectedSet, Collections.<SecCondition> emptySet(), Collections.<SecCondition> emptySet());
	...
	protected void addDomainParameters() {
		...
		domainParameterSetCardObject13.addOidIdentifier(Pace.OID_IDENTIFIER_id_PACE_ECDH_GM_3DES_CBC_CBC);
		domainParameterSetCardObject13.addOidIdentifier(Pace.OID_IDENTIFIER_id_PACE_ECDH_GM_AES_CBC_CMAC_128);
		domainParameterSetCardObject13.addOidIdentifier(Pace.OID_IDENTIFIER_id_PACE_ECDH_GM_AES_CBC_CMAC_192);
		domainParameterSetCardObject13.addOidIdentifier(Pace.OID_IDENTIFIER_id_PACE_ECDH_GM_AES_CBC_CMAC_256);
