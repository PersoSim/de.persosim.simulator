...
public class TestAuthObject extends PasswordAuthObjectWithRetryCounter {
	...
	public TestAuthObject(AuthObjectIdentifier identifier, byte[] password, String passwordName,
		...
		super(identifier, password, passwordName, minLengthOfPasswordInBytes, maxLengthOfPasswordInBytes,
				defaultValueRetryCounter, pinManagementCondition, changePinCondition, unblockPinCondition, resetPinCondition);
	}
	...
	public void setLifeCycleState(Iso7816LifeCycleState newState) throws IllegalArgumentException, IllegalAccessException, NoSuchFieldException, SecurityException {
